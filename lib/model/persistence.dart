...
class Persistence {
  ...
  static Future<bool> export() async {
    ...
    final json = {
      appTheme.key: appTheme.value.index,
      colorScheme.key: colorScheme.value.index,
      splitLayout.key: splitLayout.value.index,
      plannedSize.key: plannedSize.value.index,
